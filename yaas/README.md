...
Specification kỹ thuật cho một **Content Factory YouTube** vận hành bởi một người, laptop, ngân sách khởi điểm ~0, ưu tiên AI mã nguồn mở. Viết theo chuẩn knowledge base để mọi AI (GPT, Claude, Gemini, Qwen, DeepSeek, Mistral, Llama...) đọc và áp dụng nhất quán.
...
2. Mọi khẳng định gắn nhãn nguồn: `[T1]` official docs/paper/benchmark · `[T2]` case study/production usage đã xác minh · `[T3]` creator/community consensus · `INSUFFICIENT EVIDENCE` khi không đủ nguồn · `VERIFY` khi số liệu có thể đã cũ (knowledge cutoff của AI viết spec: 01/2026, có kiểm chứng web bổ sung 07/2026).
...
|---|---|---|
| `00-kien-truc-tong-the.md` | Kiến trúc Content Factory, State Machine 20 trạng thái, nguyên tắc thiết kế | ✅ |
